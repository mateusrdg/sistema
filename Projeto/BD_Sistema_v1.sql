...
CREATE TABLE `cliente` (
  ...
  `data_cadastro` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `endereco` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rua` varchar(45) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `estado` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `sigla` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  `codigo` varchar(2) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `fornecedor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome_razao` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `nome_fantasia` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cpf_cnpj` varchar(14) COLLATE utf8_unicode_ci DEFAULT NULL,
