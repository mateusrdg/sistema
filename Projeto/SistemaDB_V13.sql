...
CREATE TABLE `compra_item` (
  ...
  `gerou_estoque` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pedido_compra_item_produto_idx` (`produto_id`),
  KEY `fk_pedido_compra_item_pedido_compra_idx` (`compra_id`),
  CONSTRAINT `fk_compra_item_compra` FOREIGN KEY (`compra_id`) REFERENCES `compra` (`id`),
  CONSTRAINT `fk_compra_item_produto` FOREIGN KEY (`produto_id`) REFERENCES `produto` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entrada_estoque` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_entrada_estoque_pedido_compra_item_id_idx` (`compra_item_id`),
  KEY `fk_entrada_estoque_estoque_id_idx` (`estoque_id`),
  CONSTRAINT `fk_entrada_estoque_compra_item_id` FOREIGN KEY (`compra_item_id`) REFERENCES `compra_item` (`id`),
  CONSTRAINT `fk_entrada_estoque_estoque_id` FOREIGN KEY (`estoque_id`) REFERENCES `estoque` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `forma_pagamento_compra` (
  ...
  `compra_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_forma_pagamento_compra_forma_pedido_compra_id_idx` (`compra_id`),
  KEY `fk_forma_pagamento_compra_forma_pagamento_id_idx` (`forma_pagamento_id`),
  CONSTRAINT `fk_forma_pagamento_compra_forma_compra_id` FOREIGN KEY (`compra_id`) REFERENCES `compra` (`id`),
...
CREATE TABLE `forma_pagamento_venda` (
  ...
  KEY `fk_forma_pagamento_venda_pedido_venda_id_idx` (`venda_id`),
  CONSTRAINT `fk_forma_pagamento_pedido_forma_pagamento` FOREIGN KEY (`forma_pagamento_id`) REFERENCES `forma_pagamento` (`id`),
  CONSTRAINT `fk_forma_pagamento_venda_venda_id` FOREIGN KEY (`venda_id`) REFERENCES `venda` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pessoa_telefone` (
  ...
  `pessoa_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pessoa_telefone_telefone_id_idx` (`telefone_id`),
  CONSTRAINT `fk_pessoa_telefone_telefone_id` FOREIGN KEY (`telefone_id`) REFERENCES `telefone` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `venda_item` (
  ...
  `venda_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pedido_venda_item_pedido_venda_idx` (`venda_id`),
...
-- Dump completed on 2019-09-14 21:10:53
